...
type GlobalSalespersonGroup =
  RouterOutputs["salesCommissions"]["report"]["globalSalespersonGroups"][number];

export function GlobalSalespersonReport({
  groups,
}: {
  ...
  return (
    <section className="space-y-4" aria-label="Sales grouped by salesperson">
